# -*- coding: utf-8 -*-
"""
Created on Mon Oct 17 13:56:01 2022
...
class Library:
    def __init__(self, city, street, zip_code, open_hours :str, phone):
        ...
        self.phone = phone
    def __str__(self):
        return f"Miasto: {self.city}, Ulica: {self.street}, Kod pocztowy: {self.zip_code}, Godziny otwarcia: {self.open_hours}, Tel: {self.phone}"
...
class Employee:
    def __init__(self, first_name, last_name, hire_date, birth_date, city, street, zip_code, phone):
        ...
        self.phone = phone
    def __str__(self):
        return f"Imie: {self.first_name}, Nazwisko: {self.last_name}, Zatrudniony: {self.hire_date}, Urodzony: {self.birth_date}, Miasto: {self.city}, Ulica: {self.street}, Kod pocztowy: {self.zip_code}, Tel: {self.phone}"
